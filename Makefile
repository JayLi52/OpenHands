...
start-backend:
	...
	@export DEBUG_MODE=true && export DEBUG_PORT=5678 && poetry run uvicorn openhands.server.listen:app --host $(BACKEND_HOST) --port $(BACKEND_PORT) --reload --reload-exclude "./workspace"
...
_run_setup:
	...
	@export DEBUG_MODE=true && export DEBUG_PORT=5678 && poetry run uvicorn openhands.server.listen:app --host $(BACKEND_HOST) --port $(BACKEND_PORT) &
